...
function Interview() {
  ...
  const [question, setQuestion] = useState<QuestionType[] | null>(questions); // array of questions generated by AI
    ...
    async function getQuestion() {
      ...
      try {
        const response = await axios.post(
          `${process.env.NEXT_PUBLIC_URL}/api/generate-questions`,
          {
            role: query.get("role"),
            tech: query.get("tech"),
  ...
  function handleNext() {
    ...
    if (active === questions.length - 1) {
      ...
      if (question != null) {
        ...
        addQuestion({ question: question[active].question, answer });
        setAnswer("");
      }
    }
  }
      ...
      <div className="w-full flex flex-col pb-20">
        {question !== null && start ? (
          ...
          <div className="text-center">
            ...
            <TextShimmerWave
              className='[--base-color:#0D74CE] [--base-gradient-color:#5EB1EF] text-3xl'
              duration={1}
              spread={1}
              zDistance={1}
              scaleDistance={1.1}
        ...
        <div className="w-3/5 bg-zinc-950 p-4 z-10 fixed bottom-0 border-t ">
          {/* <button
            onClick={handleNext}
            disabled={isFetching}
            className="border border-green-800 bg-green-700 text-green-50 disabled:bg-zinc-700/30  disabled:border-none disabled:cursor-not-allowed flex justify-center items-center gap-2 rounded-xl p-2 px-5  min-w-44 w-full mx-auto disabled:text-zinc-600"
          >
            Next
          </button> */}
